package br.com.github.renato28.service;

import br.com.github.renato28.client.ClientHttpConfiguration;
import br.com.github.renato28.domain.Abrigo;
...
public class AbrigoService {
    ...
    public void listarAbrigos() throws IOException, InterruptedException {
        String uri = "https://localhost:8080/abrigos";
        HttpResponse<String> response = client.dispararRequisicaoGet(uri);
        String respondeBody = response.body();
        Abrigo[] abrigos = new ObjectMapper().readValue(respondeBody, Abrigo[].class);
    ...
    public void cadastrarAbrigo() throws IOException, InterruptedException {
        ...
        if (statusCode == 200) {
            ...
            System.out.println("Erro ao cadastrar abrigo");
            System.out.println(respondeBody);
        }
    }
}
